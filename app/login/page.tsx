        ...
        <main className="min-h-screen grid lg:grid-cols-2">
            ...
            >
                ...
                <div className="absolute top-8 left-8 z-20">
                    <Link href="/" className="inline-flex items-center text-white/80 hover:text-white transition-colors gap-2 font-medium bg-black/20 backdrop-blur-md px-4 py-2 rounded-full border border-white/10 hover:bg-black/30">
                ...
                <div className="absolute bottom-20 left-12 right-12 text-white z-10">
                    <p className="text-2xl font-serif font-medium leading-relaxed mb-6">
                        "Katedra has completely transformed how I manage my classroom administration. It's not just a tool, it's a partner."
                    </p>
                    <div className="flex items-center gap-4">
                        <div className="w-12 h-12 rounded-full bg-white/20 border border-white/30" />
                        <div>
                            <p className="font-bold">Sarah Jenkins</p>
                            <p className="text-sm opacity-80">Principal, St. Academy</p>
                        </div>
                    </div>
                </div>
            </motion.div>
            ...
            >
                ...
                <div className="absolute top-6 left-6 lg:hidden">
                    <Link href="/" className="inline-flex items-center text-muted-foreground hover:text-primary transition-colors gap-2 font-medium">
                        <ArrowRight className="rotate-180" size={16} />
                        Home
                    </Link>
                </div>
                ...
                <div className="w-full max-w-md space-y-8">
                    <div className="text-center lg:text-left">
                        ...
                        <h1 className="text-3xl font-bold font-serif text-foreground mb-2">Selamat Datang Kembali</h1>
                    ...
                    <div className="relative">
                        ...
                        <div className="relative flex justify-center text-xs uppercase">
                            <span className="bg-background px-2 text-muted-foreground font-medium tracking-wider">Atau lanjutkan dengan</span>
                        </div>
                    </div>
